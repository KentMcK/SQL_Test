...
,TRANSACTIONS AS 
      ...
      TT.LINE_TYPE_CD ,TT.LINE_TYPE_dsc,
        TT.ORDR_TYPE_CD,   TT.ORDR_TYPE_DSC,I.PRMRY_TO_SELL_DIVISOR
        ,count(BMD.ASSET_ID) as ttl_device_qty
        ,sum(CASE WHEN I.PRMRY_TO_SELL_DIVISOR=0 THEN 0 ELSE I.STNDRD_COST_AMT/I.PRMRY_TO_SELL_DIVISOR END) AS "PRIMARY UOM COST"
